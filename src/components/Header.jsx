        ...
        <div className={`${isHome ? 'bg-heroBg' : 'bg-white'} bg-cover bg-bottom bg-no-repeat`}>
            <header className='py-5 border-b-2 border-white/40 z-10 backdrop-filte backdrop-blur-3x'>
                <div className="flex justify-between items-center w-full max-w-base mx-auto px-5">
                    <Link aria-label='home' title='mashina bozor' className='text-[28px] text-white font-bold leading-9' to='/'>
                        <img width={191} height={36} src={logo} alt="logo" />
                    </Link>

                    <nav>
                        <ul className={`${isHome ? 'text-white' : 'text-111'} flex items-center space-x-8 text-lg font-medium leading-7`}>
                            <li>
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        {/* call */}
                        <a title='contact' aria-label='contact' className='' href="tel:+998881690033">
                            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
